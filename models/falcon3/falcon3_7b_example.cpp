...
int main(int argc, char** argv) {
    ...
    const auto model_dir = std::filesystem::current_path() / "modelfiles" / "falcon_v3_7b_instruct-genie-w4a16-qualcomm_snapdragon_x_elite";
    ...
    model_cfg.model_paths = {
        (model_dir / "falcon_v3_7b_instruct_part_1_of_5.bin").string(),
        (model_dir / "falcon_v3_7b_instruct_part_2_of_5.bin").string(),
        (model_dir / "falcon_v3_7b_instruct_part_3_of_5.bin").string(),
        (model_dir / "falcon_v3_7b_instruct_part_4_of_5.bin").string(),
        (model_dir / "falcon_v3_7b_instruct_part_5_of_5.bin").string(),
    };
